...
// variables:
//      [GITREPO] https://github.com/Pa-van/events-app-web-server.git
    ...
    stages {
        stage('Stage 1') {
            steps {
                ...
                git branch: 'main',
                    url: 'https://github.com/Pa-van/events-app-web-server.git'
        ...
        stage('Stage 2') {
         ...
         stage('Stage 5') {
            steps {
                ...
                sh "kubectl set image deployment/demo-web demo-web=gcr.io/roidtcmar101/api-server:v2.${env.BUILD_ID} --record"
            }
        }
    }
}
